...
@Component({
  selector: 'app-dialog-edit-message-channel',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './dialog-edit-message-channel.component.html',
  styleUrls: ['./dialog-edit-message-channel.component.scss']
})
export class DialogEditMessageChannelComponent {
  messageControl: FormControl;

  constructor(
    public dialogRef: MatDialogRef<DialogEditMessageChannelComponent>,

...
import { Firestore, collection, doc, setDoc, getDocs, query, orderBy, serverTimestamp, onSnapshot } from '@angular/fire/firestore';
...
export class ThreadService {
  ...
  loadThreadMessages(channelId: string, messageId: string): Observable<Message[]> {
    const threadMessagesRef = collection(this.firestore, `channels/${channelId}/messages/${messageId}/threads`);
